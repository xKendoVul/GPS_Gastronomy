...
import { Cart, Facebook, Instagram, Twitter, Tiktok, Whatsapp, ArrowRight } from 'react-bootstrap-icons';
        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link as={Link} to="/panel">Panel de Control</Nav.Link>
      ...
      <main className="flex-grow-1">
        <Container className="py-5">
          ...
          <div className="d-flex justify-content-between align-items-center mb-4">
            <h2 className="mb-0">Platillos Destacados</h2>
          ...
          <div className="d-flex justify-content-between align-items-center mb-4">
            <h2 className="mb-0">Platillos más Consumidos</h2>
            <Button variant="outline" className="d-flex align-items-center">
              Ver Todo <ArrowRight className="ms-2" />
            </Button>
          </div>
          ...
          <div className="d-flex justify-content-between align-items-center mb-4">
            <h2 className="mb-0">Platillos Premium</h2>
            <Button variant="outline" className="d-flex align-items-center">
              Ver Todo <ArrowRight className="ms-2" />
            </Button>
          </div>
